...
<head>
    ...
    <title>爱客服 | 后台登录</title>
    <link rel="stylesheet" href=src="/static/plugins/bootstrap/css/bootstrap.min.css">
    <link rel="stylesheet" href=src="/static/plugins/animate/animate.min.css">
    <link rel="stylesheet" href=src="/static/plugins/toast/css/jquery.toast.min.css">
...
<script src=src="/static/plugins/jquery/jquery.min.js"></script>
<script src=src="/static/plugins/bootstrap/js/bootstrap.min.js"></script>
<script src=src="/static/plugins/toast/js/jquery.toast.min.js"></script>
